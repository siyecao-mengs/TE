...
public partial class SliderRounded : UserControl
{
    ...
    public void Configure(double width, double height, double trackHeight, double scrollMax, double speed, bool reversed, string color, double opacity, double radius)
    {
        _trackHeight = trackHeight;
        _scrollMax = scrollMax;
        Width = width;
        Height = height;
        Thumb.CornerRadius = new CornerRadius(radius);
